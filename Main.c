...
int main() {
string inputFileName, encryptedFileName, decryptedFileName;
...
encryptAES(inputFileName, encryptedFileName, AES_KEY);
...
decryptAES(encryptedFileName, decryptedFileName, AES_KEY);
